		...
		<h1 class="mt-4">출결 등록</h1>
			...
			<div class="card mb-4">
				<form role="form" action="/human/at-register" method="post">
			        ...
			        <div class="form-group">
			            <label>출장 여부(Y/N)</label> <input class="form-control" name='atd_bt'>
			        </div><br>
			        
			        <div class="form-group">
			            <label>출장 기간</label> <input class="form-control" name='atd_bt_dt'>
			        </div><br>
			        ...
			        <div class="form-group">
			            <label>파견 여부(Y/N)</label> <input class="form-control" name='atd_dp'>
			        </div><br>
			        
			        <div class="form-group">
			            <label>파견 기간</label> <input class="form-control" name='atd_dp_dt'>
			        </div><br>
